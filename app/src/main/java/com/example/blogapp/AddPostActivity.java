...
public class AddPostActivity extends AppCompatActivity {
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(title)){
                    title_blog.setError("Blog Başlığı Gerekiyor!");
                }
                else if (TextUtils.isEmpty(description)){
                    description_blog.setError("Blog Açıklaması Gerekiyor!");
                }
                else {
    ...
    private void uploadData(final String title, final String description) {
        ...
        pd.setMessage("Blog Paylaşılıyor");
        pd.show();
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (uriTask.isSuccessful()){
                                ...
                                DatabaseReference databaseReference = FirebaseDatabase.getInstance("https://blogapp-7273d-default-rtdb.europe-west1.firebasedatabase.app").getReference("Posts");
                                databaseReference.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            @Override
                                            public void onSuccess(Void aVoid) {
                                                pd.dismiss();;
                                                Toast.makeText(AddPostActivity.this, "Blog Paylaşıldı", Toast.LENGTH_SHORT).show();
                                                title_blog.setText("");
    ...
    private void imagePickDialog() {
        ...
        builder.setTitle("Fotoğrafın Seçileceği Yer");
